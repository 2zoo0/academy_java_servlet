 ...
 * 이 필터가 작동할 주소 형태 등록
 * urlPatterns : /*
 * 				==> 이 서비스(애플리케이션)의 컨텍스트 패스 이하로 들어오는 모든 요청주소에 대하여 이 필터가 작동함
 * 
 * @author PC38207
 *
 */
...
public class EncodingFilter implements Filter {
	...
	public void init(FilterConfig config) throws ServletException {
		/* 필터의 init() 메소드는 서블릿 컨테이너(톰켓) 에 의해
		 * 필터 초기화 시에 자동으로 작동함.
	...
	public void doFilter(ServletRequest req
		...
		System.out.println(" book===== 1.인코딩 필터 진입 ===== ");
		//(1) 요청에 대한 인코딩 설정 : 한글 설정
		...
		System.out.println(" book===== 1. 인코딩 필터 종료 ===== ");
	}
